...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_ports Clock]

##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { Input[0] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { Input[1] }]; #IO_L24P_T3_34 Sch=sw[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { Input[2] }]; #IO_L4N_T0_34 Sch=sw[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { Input[3] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]


##Buttons
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L24N_T3_34 Sch=btn[1]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports Button]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { Halt }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { Input[4] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { Input[5] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { Input[6] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports { Input[7] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]

set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { Output[3] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { Output[4] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { Output[5] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { Output[6] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { Output[7] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]

set_property PULLDOWN true [get_ports {Input[7]}]
